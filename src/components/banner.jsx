  ...
  return (
    <div className="relative bg-white py-16">
      <div className="container mx-auto flex flex-col md:flex-row justify-between gap-8">
        ...
        <div className="bg-blue-700 p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center max-w-[700px] w-full max-h-[400px] h-full relative overflow-hidden">
        ...
        <div className="bg-pink-500 p-8 rounded-lg shadow-lg flex flex-col md:flex-row items-center max-w-[700px] w-full  max-h-[400px] h-full relative overflow-hidden">
          <div className="md:w-1/2">
          ...
          <div className="md:w-1/2 flex justify-center items-center relative">
            <img 
              src={ceweNunjuk2}
              alt="Pekerjaan" 
              className="max-w-[250px] max-h-[500px] rounded-lg object-cover z-10" 
            />
